...
static func tableroTienda (_color: String, precio: String, descripcion: String, nuevo_tipo: TIPO_SKIN) -> tableroTienda:
	...
	nuevo_elemento_tienda.tipo = nuevo_tipo
	if nuevo_tipo == TIPO_SKIN.FICHA:
	...
	nuevo_elemento_tienda.boton_comprar.button_group = LISTA_BUTTON_GROUPS[nuevo_tipo]
